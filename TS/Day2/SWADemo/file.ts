...
var p3:Point2D = new Point3D(23,33)
console.log((p3 as Point3D).display())
...
abstract class abstractInterview{
   ...
   protected endTime:string=""
    constructor(st:string,ed:string){
        this.startTime=st
        this.endTime = ed
    }
    abstract printInterview():void
}
// class MyInterview implements IInterview{
abstract class MyInterview extends abstractInterview{
    // startTime?: string | undefined
    // endTime!: string
    description:string=""
   constructor(st:string,ed:string,des:string){
    super(st,ed)
...
// var inter1 = new MyInterview("xyz","abc","test")
// console.log(inter1.endTime)
// console.log(inter1.description)
// inter1.printInterview()
interface IsSized{
    length:number
}
