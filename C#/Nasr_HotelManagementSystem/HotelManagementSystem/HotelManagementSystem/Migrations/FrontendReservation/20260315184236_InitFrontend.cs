...
{
    /// <inheritdoc />
    public partial class InitFrontend : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoomType = table.Column<string>(type: "nchar(10)", fixedLength: true, maxLength: 10, nullable: false),
                    RoomFloor = table.Column<string>(type: "nchar(10)", fixedLength: true, maxLength: 10, nullable: false),
                    RoomNumber = table.Column<string>(type: "nchar(10)", fixedLength: true, maxLength: 10, nullable: false),
                    ...
                    CardType = table.Column<string>(type: "nchar(10)", fixedLength: true, maxLength: 10, nullable: false),
                    CardNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CardExp = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CardCvc = table.Column<string>(type: "nchar(10)", fixedLength: true, maxLength: 10, nullable: false),
                    ArrivalTime = table.Column<DateOnly>(type: "date", nullable: false),
                    LeavingTime = table.Column<DateOnly>(type: "date", nullable: false),
